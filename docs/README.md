...
### SmartHR(2023/05~2024/10）

- **SmartHR での基本的な開発スタイル**
  1. スクラム（LeSS）
  2. TDD

**【プロダクト 人事評価 機能の新規機能開発（2024 年上期）】**

- **プロジェクト概要：**
  - タレマネの Land プロダクトとして MMB 以上の獲得を牽引できるプロダクトになる
- **規模**
  - 5 名
- **期間**
  - 2024/01 ~ 2024/06
...
- **サイドタスク**
  - チームも巻き込んで行うこともありますが、個人でボールを持って進めるタスクです
    - QA の方と一緒にテスト設計と Playwright で E2E の実装
      - チームへ運用方針を共有
...
- **サイドタスク**
  - チームも巻き込んで行うこともありますが、個人でボールを持って進めるタスクです
    ...
    - パフォーマンスの改善
      - N+1 の修正
      - index の貼り直し
        - Newrelic や Cloud Logging、Query Insights を見て改善箇所を見つけたりしてます
    - rails のバージョンアップ
